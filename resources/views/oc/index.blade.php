...
@section('page-subtitle', 'Visualización de documento comercial')
            ...
            <div class="flex items-start gap-2">
                ...
                <div class="flex-1">
                    <p class="text-sm text-emerald-800">
                        Orden de Compra (OC) asociada a la Nota de Venta <strong>{{ $folio }}</strong>
                    </p>
                </div>
            </div>
        </div>
...
<script>
                ...
                <div class="flex items-center justify-center h-full p-12">
                    <div class="text-center">
                        ...
                        <a href="{{ $fileUrl ?? '#' }}" 
                           target="_blank"
                           download
                           class="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg transition-all">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                      d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
                            </svg>
    ...
    window.addEventListener('load', function() {
        showAlert('warning', 'No se encontró la OC para este folio');
    });
    @endif
</script>
@endpush
