...
@section('title', 'OC - Orden de Compra')
@section('page-title', 'Orden de Compra (OC)')
@section('page-subtitle', 'Visualización de documentos comerciales')
...
<div class="p-6">
    ...
    @if(!$tieneDocumentos)
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 p-12">
            <div class="text-center max-w-md mx-auto">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-3">OC No Disponible</h3>
                <p class="text-gray-600 mb-6">
                    No se encontró la Orden de Compra (OC) para la Nota de Venta 
                    <strong class="text-emerald-600">{{ $folio }}</strong>
                </p>
                <div class="flex items-center justify-center gap-3">
                    <a href="{{ route('dashboard') }}" 
                       class="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg transition-all shadow-md hover:shadow-lg">
    ...
    @else
        ...
        <div class="bg-white rounded-xl shadow-md p-4 mb-6 border border-emerald-100">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">OC - Orden de Compra</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <button onclick="verVistaPrevia('{{ $archivo['url'] }}', '{{ $archivo['nombre'] }}')" 
                                            class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm rounded-lg font-medium transition-all shadow-sm hover:shadow-md"
            ...
            <div class="flex items-start gap-2">
                ...
                <div class="flex-1">
                    <p class="text-sm text-emerald-800">
                        <strong>Órdenes de Compra (OC)</strong> asociadas a la Nota de Venta <strong>{{ $folio }}</strong>. 
        ...
        <div class="bg-white rounded-t-xl px-6 py-4 flex items-center justify-between shadow-lg">
            ...
            <div class="flex items-center gap-2">
                <button onclick="imprimirDocumento()" 
                        class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-all shadow-md hover:shadow-lg">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        ...
        <div class="flex-1 bg-white rounded-b-xl shadow-2xl overflow-hidden relative">
            ...
            <div id="loadingPreview" class="absolute inset-0 bg-white flex items-center justify-center z-10">
                <div class="text-center">
                    <svg class="animate-spin h-12 w-12 text-emerald-600 mx-auto mb-4" fill="none" viewBox="0 0 24 24">
        ...
        if (iframe && iframe.contentWindow) {
            try {
                ...
                if (typeof showAlert !== 'undefined') {
                    showAlert('error', 'No se puede imprimir desde el visor. Descarga el archivo e imprímelo.');
                } else {
                    alert('No se puede imprimir desde el visor. Descarga el archivo e imprímelo.');
                }
            }
        }
    }
